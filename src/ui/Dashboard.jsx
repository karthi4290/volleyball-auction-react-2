...
export default function Dashboard({ setTab }) {
  ...
  const totals = useMemo(() => {
    const totalBudget = state.teams.reduce(
    ...
    const remaining = state.teams.map(
      (t) => (Number(t.budget) || 0) - (spentByTeam[t.id] || 0)
    );
    return {
      totalBudget,
  ...
  return (
    ...
    >
      <div
        ...
        style={{ textAlign: "center", paddingTop: 48, marginBottom: 18 }}
      >
        <h2
      ...
      <div
        ...
        style={{ maxWidth: "100vw", margin: "0 auto", padding: "0 32px" }}
      >
        <div
        ...
        <div
          className="form-actions dashboard-actions"
          style={{
            display: "flex",
            gap: 18,
            justifyContent: "center",
        ...
        >
          ...
          <button
            ...
            onClick={() => {
              if (
                window.confirm(
                  "Are you sure you want to reset the auction? This will remove all sold players from teams."
                )
              ) {
                        ...
                        >
                          {soldPlayersByTeam[team.id].map((player) => (
                            <div
                              ...
                              style={{
                                background:
                                  "linear-gradient(90deg, #e0e7ef 0%, #f3f6fc 100%)",
                                borderRadius: 12,
                                boxShadow: "0 2px 8px #e0e7ef",
                                padding: "12px 18px",
                                minWidth: 180,
                            ...
                            >
                              ...
                              <div>
                                ...
                                >
                                  Price:{" "}
                                  {Number(player.price || 0).toLocaleString()}
                                </div>
                              </div>
                            </div>
                          ))}
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ fontSize: 32, color: "#2563eb", fontWeight: 900 }}
      >
        {value}
      </div>
    </div>
